        ...
        setStyle: function (a) {
          ...
          if (/^\#([0-9a-f])([0-9a-f])([0-9a-f])$/i.test(a))
            return (
              ...
              this.setHex(
                parseInt(a[1] + a[1] + a[2] + a[2] + a[3] + a[3], 16)
              ),
              this
            );
          if (/^(\w+)$/i.test(a))
      ...
      THREE.extend(THREE.Frustum.prototype, {
        ...
        intersectsSphere: function (a) {
          for (
            var b = this.planes, c = a.center, a = -a.radius, d = 0;
            6 > d;
            d++
          )
      ...
      THREE.Object3D.prototype = {
        ...
        worldToLocal: function (a) {
          return a.applyMatrix4(
            THREE.Object3D.__m1.getInverse(this.matrixWorld)
          );
        },
        lookAt: function (a) {
          ...
          for (m = E.objects.length; g < m; g++)
            if (
              ...
              for (ka = nb.length; pa < ka; pa++) {
                aa = nb[pa];
                var Xa =
                  !0 === Wa ? ab.materials[aa.materialIndex] : oa.material;
                if (void 0 !== Xa) {
                  la = Xa.side;
            ...
            if (((a = this.faces[f]), a instanceof THREE.Face3)) {
              ...
              if (0 <= d) {
                ...
                a.vertexNormals &&
                  ...
                  ((l.vertexNormals = a.vertexNormals),
                  l.vertexNormals.splice(d, 1));
                a.vertexColors &&
                  0 < a.vertexColors.length &&
                  ((l.vertexColors = a.vertexColors),
        ...
        createMaterial: function (a, b) {
          ...
          a.mapNormal
            ? ((h = THREE.ShaderLib.normalmap),
              ...
              i.map &&
                ((k.tDiffuse.value = i.map), (k.enableDiffuse.value = !0)),
              i.specularMap &&
                ((k.tSpecular.value = i.specularMap),
                (k.enableSpecular.value = !0)),
              i.lightMap &&
                ((k.tAO.value = i.lightMap), (k.enableAO.value = !0)),
              k.uDiffuseColor.value.setHSL(110,93,52),
              k.uSpecularColor.value.setHSL(110,93,52),
              k.uAmbientColor.value.setHSL(110,93,52),
            ...
            if (void 0 === x.objects[p]) {
              ...
              if (q.type && q.type in l.hierarchyHandlerMap) {
                ...
                if ((n = x.geometries[q.geometry])) {
                  ...
                  m = q.quaternion;
                  q.material ||
                    (s = new THREE.MeshFaceMaterial(
                      x.face_materials[q.geometry]
                    ));
        ...
        for (F in J.textures) {
          ...
          if (B.url instanceof Array) {
            ...
            (q = /\.dds$/i.test(B.url)),
              ...
              void 0 !== THREE[B.minFilter] &&
                (q.minFilter = THREE[B.minFilter]),
              void 0 !== THREE[B.magFilter] &&
                (q.magFilter = THREE[B.magFilter]),
        ...
        for (K in J.materials) {
          ...
          F.parameters.normalMap
            ? ((E = THREE.ShaderLib.normalmap),
              ...
              F.parameters.map &&
                ((B.tDiffuse.value = F.parameters.map),
              ...
              F.parameters.lightMap &&
                ((B.tAO.value = F.parameters.lightMap),
                (B.enableAO.value = !0)),
              ...
              F.parameters.displacementMap &&
                ((B.tDisplacement.value =
                  x.textures[F.parameters.displacementMap]),
              ...
              if (f instanceof THREE.DirectionalLight) {
                ...
                f instanceof THREE.PointLight &&
                  ...
                  0 >= j ||
                    ...
                    0 != j &&
                      ((j *= f.intensity), c.add(gb.multiplyScalar(j)))));
            }
          }
                  ...
                  (void 0 !== P.envMap && null !== P.envMap)
                    ...
                    : ((M = X.positionScreen.x),
                      ...
                      P instanceof THREE.MeshPhongMaterial
                        ? (Z.copy(P.color),
                          oa.copy(P.emissive),
                          P.vertexColors === THREE.FaceColors &&
                            Z.multiply(H.color),
                          !0 === gc
                            ? !1 === P.wireframe &&
                              ...
                              ? (pa.copy(vb),
                                ...
                                q(
                                  H.v1.positionWorld,
                                  H.vertexNormalsModel[0],
                                  pa
                                ),
                                q(
                                  H.v2.positionWorld,
                                  H.vertexNormalsModel[1],
                                  Y
                                ),
                                q(
                                  H.v4.positionWorld,
                                  H.vertexNormalsModel[3],
                                  da
                                ),
                                q(
                                  H.v3.positionWorld,
                                  H.vertexNormalsModel[2],
                                  la
                                ),
                                pa.multiply(Z).add(oa),
                                Y.multiply(Z).add(oa),
                        ...
                        : P instanceof THREE.MeshDepthMaterial &&
                          ...
                          (pa.r =
                            ...
                            pa.b =
                              1 -
                              k(
                                X.positionScreen.z * X.positionScreen.w,
                                Wa,
                                ab
                              )),
                          (Y.r =
                            ...
                            Y.b =
                              1 -
                              k(
                                wa.positionScreen.z * wa.positionScreen.w,
                                Wa,
                                ab
                              )),
                          (da.r =
                            ...
                            da.b =
                              1 -
                              k(
                                hb.positionScreen.z * hb.positionScreen.w,
                                Wa,
                                ab
                              )),
                          (la.r =
                            ...
                            la.b =
                              1 -
                              k(
                                Bb.positionScreen.z * Bb.positionScreen.w,
                                Wa,
                                ab
                              )),
                          (Fa = E(pa, Y, da, la)),
      ...
      THREE.WebGLRenderer = function (a) {
        ...
        function A(a, b, c, d, e) {
          ...
          d.morphTargets &&
            ...
            (e.__webglMorphTargetInfluences = new Float32Array(
              N.maxMorphTargets
            ));
          var f = !1,
            g = d.program,
                ...
                if (
                  ...
                  k.castShadow &&
                    (k instanceof THREE.SpotLight ||
                      (k instanceof THREE.DirectionalLight &&
                        !k.shadowCascade)))
                )
            ...
            for (Z = b.length; i < Z; i++)
              if ((f = g.uniforms[b[i][1]]))
                if (((c = b[i][0]), (l = c.type), (k = c.value), "i" === l))
                  ...
                  void 0 === c._array &&
                    (c._array = new Float32Array(2 * k.length));
                  l = 0;
                  ...
                  void 0 === c._array &&
                    (c._array = new Float32Array(3 * k.length));
                  l = 0;
                  for (m = k.length; l < m; l++)
                    (r = 3 * l),
                      (c._array[r] = k[l].x),
                  ...
                  void 0 === c._array &&
                    (c._array = new Float32Array(4 * k.length));
                  l = 0;
                  for (m = k.length; l < m; l++)
                    (r = 4 * l),
                      (c._array[r] = k[l].x),
              ...
              if (f.morphTargetForcedOrder.length) {
                ...
                for (
                  ...
                  0 <= c["morphTarget" + h] &&
                    (j.bindBuffer(
                      j.ARRAY_BUFFER,
                      e.__webglMorphTargetsBuffers[i[h]]
                    ),
                    k(c["morphTarget" + h]),
                    j.vertexAttribPointer(
                      c["morphTarget" + h],
            ...
            f instanceof THREE.Mesh
              ? (d.wireframe
                  ? (J(d.wireframeLinewidth),
                    b &&
                      j.bindBuffer(j.ELEMENT_ARRAY_BUFFER, e.__webglLineBuffer),
                    j.drawElements(
                      j.LINES,
                      e.__webglLineCount,
                      j.UNSIGNED_SHORT,
                  ...
                  : (b &&
                      j.bindBuffer(j.ELEMENT_ARRAY_BUFFER, e.__webglFaceBuffer),
                    j.drawElements(
                      j.TRIANGLES,
                      e.__webglFaceCount,
                      j.UNSIGNED_SHORT,
          ...
          for (var oa = 0, ra = a.__webglObjects.length; oa < ra; oa++) {
            ...
            if (ta instanceof THREE.Mesh)
              if (O instanceof THREE.BufferGeometry)
                ...
                for (
                  var Ca = 0, Ka = O.geometryGroupsList.length;
                  Ca < Ka;
                  Ca++
                )
                  if (
                    ...
                    if (sa.__inittedArrays) {
                      ...
                      if (pc.length) {
                        ...
                        0 < ba &&
                          (j.bindBuffer(
                            j.ARRAY_BUFFER,
                            sa.__webglSkinIndicesBuffer
                          ),
                          j.bufferData(j.ARRAY_BUFFER, Ha, Pa),
                          j.bindBuffer(
                            j.ARRAY_BUFFER,
                            sa.__webglSkinWeightsBuffer
                          ),
        ...
        this.setMaterialFaces = function (a) {
          ...
          da !== b &&
            (b ? j.disable(j.CULL_FACE) : j.enable(j.CULL_FACE), (da = b));
      ...
      THREE.WebGLRenderTarget = function (a, b, c) {
        ...
        this.magFilter =
          void 0 !== c.magFilter ? c.magFilter : THREE.LinearFilter;
        this.minFilter =
          ...
          if (a instanceof Array)
            ...
            (k = new XMLHttpRequest()),
              (k.onload = function () {
                ...
                if (a.isCubemap) {
                  for (
                    var b = a.mipmaps.length / a.mipmapCount, d = 0;
                    d < b;
                    d++
                  ) {
                    e[d] = { mipmaps: [] };
                      ...
                      for (k in h) {
                        for (
                          ...
                          if (a.hierarchy[c].keys[d].morphTargets[i] === k) {
                            l[k] =
                              a.hierarchy[c].keys[d].morphTargetsInfluences[i];
                            break;
                          }
                        i === a.hierarchy[c].keys[d].morphTargets.length &&
                          (l[k] = 0);
      ...
      THREE.Animation = function (a, b, c) {
        ...
        this.interpolationType =
          void 0 !== c ? c : THREE.AnimationHandler.LINEAR;
        this.points = [];
      ...
      THREE.Animation.prototype.update = function (a) {
        if (!1 !== this.isPlaying) {
          ...
          parseInt(
            Math.min(k * this.data.fps, this.data.length * this.data.fps),
            10
          );
      ...
      THREE.AsteriskGeometry.prototype = Object.create(
        THREE.Geometry.prototype
      );
      ...
      THREE.PolyhedronGeometry = function (a, b, c, d) {
        ...
        THREE.Geometry.call(this);
        for (
          var c = c || 1, d = d || 0, i = this, k = 0, l = a.length;
          k < l;
          k++
        )
      ...
      THREE.ConvexGeometry = function (a) {
        ...
        for (d = 0; d < c.length; d++) {
          ...
          for (h = 0; 3 > h; h++)
            void 0 === f[g[h]] &&
              ((f[g[h]] = e++), this.vertices.push(a[g[h]])),
              (g[h] = f[g[h]]);
        }
        for (d = 0; d < c.length; d++)
      ...
      THREE.CameraHelper.prototype.update = function () {
        ...
        var b = this;
        THREE.CameraHelper.__c.projectionMatrix.copy(
      ...
      THREE.HemisphereLightHelper = function (a, b, c) {
        ...
        this.lightSphere = new THREE.Mesh(
          f,
          new THREE.MeshFaceMaterial([h, i])
        );
      ...
      THREE.SpritePlugin = function () {
        ...
        this.init = function (a) {
          ...
          l.useScreenCoordinates = b.getUniformLocation(
            i,
      ...
      function init() {
        ...
        const wrapper = document.querySelector(".section-home-header");
        ...
        for (var ix = 0; ix < AMOUNTX; ix++) {
          for (var iy = 0; iy < AMOUNTY; iy++) {
            const randColors = [0xc98fc6, 0xc88bc4 , 0x7b8fdd];
                        // const randColors = [0xffffff, 0xcccccc, 0xff0000];
            particle = particles[i++] = new THREE.Particle(new THREE.ParticleCanvasMaterial({
                color: ix < AMOUNTX / 3 ? randColors[0] : ix > (AMOUNTX / 3) * 2 ? randColors[1] : randColors[2],
                // color: ix % 2 === 0 || iy % 2 === 0 ? randColors[0] : randColors[1],
                // color: randColors[Math.floor(Math.random() * randColors.length)],
                program: function (context) {
            context.beginPath();
            context.arc(0, 0, 0.6, 0, PI2, true);
            context.fill();
        ...
        wrapper.addEventListener("mousemove", onDocumentMouseMove, false);
